<template>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Добавить секцию документации</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form">
            ...
            <div class="box-footer">
                <div class="form-group">
                    <button @click="create" class="btn btn-primary btn-flat" :disabled="disabled">Создать секцию</button>
                </div>
            </div>
        </form>
    </div>
	...
	export default {
        ...
        methods: {
        	...
        	create() {
        		...
        		this.$db.table('docSection').insert({
                    name: this.title,
                	...
                	this.$router.push('/docs/sections/'+data.generated_keys[0])
                })
            }
        }
	}
